...
const R = (
  ...
  ten: "—", promo, exam, retire: "", incr, note,
});
...
export const RANK_TABLE: [string, number, number, number, number, number][] = [
  ["一级", 1, 3020, 3270, 3520, 3770],
  ["二级", 2, 2770, 3005, 3240, 3475],
  ["三级", 3, 2540, 2760, 2980, 3200],
  ["四级", 4, 2330, 2535, 2740, 2945],
  ["五级", 5, 2105, 2290, 2475, 2660],
  ["六级", 6, 1895, 2055, 2215, 2375],
  ["七级", 7, 1700, 1845, 1990, 2135],
  ["八级", 8, 1600, 1735, 1870, 2005],
  ["九级", 9, 1500, 1625, 1750, 1875],
  ["十级", 10, 1405, 1520, 1635, 1750],
  ["十一级", 11, 1315, 1420, 1525, 1630],
  ["十二级", 12, 1230, 1325, 1420, 1515],
  ["十三级", 13, 1150, 1235, 1320, 1405],
  ["十四级", 14, 1060, 1135, 1210, 1285],
  ["十五级", 15, 950, 1020, 1090, 1160],
  ["十六级", 16, 870, 935, 1000, 1065],
  ["十七级", 17, 790, 850, 910, 970],
  ["十八级", 18, 720, 775, 830, 885],
  ["十九级", 19, 655, 705, 755, 805],
  ["二十级", 20, 590, 635, 680, 725],
  ["二十一级", 21, 545, 585, 625, 665],
  ["二十二级", 22, 500, 535, 570, 605],
  ["二十三级", 23, 460, 490, 520, 550],
  ["二十四级", 24, 425, 450, 475, 500],
  ["二十五级", 25, 380, 400, 420, 440],
  ["二十六级", 26, 355, 375, 395, 415],
  ["二十七级", 27, 330, 347, 364, 381],
];

export const DUTY_TABLE: [string, number, number][] = [
  ["国家级正职", 4500, 1],
  ["国家级副职", 4000, 2],
  ["省部级正职", 3500, 3],
  ["省部级副职", 3000, 4],
